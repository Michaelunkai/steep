...
elseif (-not $SkipConfirmations) {
    ...
    Write-Host "• System integrity check and repair (SFC, DISM, CHKDSK)" -ForegroundColor Yellow
...
function Start-SystemOptimization {
    ...
    $operationCount = 0
    # Adjust total operations - added system integrity check
    if ($global:RestartChoice -eq "none") {
        $totalOperations = 21  # Added system integrity check operation
    } else {
        $totalOperations = 22  # Added system integrity check operation
    }
...
Write-Host "  • 🔧 System integrity check and repair (SFC, DISM, CHKDSK) 🔧" -ForegroundColor Magenta
...
Write-Host "✅ System integrity check timeouts (SFC: 15min, DISM: 20min, CHKDSK: 25min)" -ForegroundColor Green
